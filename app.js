        ...
        return [
            {
                ...
                sel: '.lib-grid',
                title: '① 시간표 저장소',
                text: '학년을 고르면 나오는 첫 화면입니다. 지금까지 만든 시간표가 카드로 쌓여 있어요.<br>카드를 누르면 그 시간표를 1단계부터 이어서 편집합니다. 막대는 얼마나 채워졌는지, <b>완성</b> 배지는 빈 칸이 하나도 없다는 뜻입니다.<br>여기서 정한 <b>시간표 이름</b>은 나중에 PDF·이미지로 저장하거나 인쇄할 때 <b>문서 제목</b>이 됩니다. <b>“5주차(9.14-9.18)”</b>처럼 지어두면 제목도 그대로 그렇게 나와요.'
            },
            {
                sel: '.lib-sample',
                title: '첫 카드는 샘플',
            ...
            },
            {
                ...
                title: '저장 · 인쇄',
                text: '완성한 시간표를 <b>PDF</b>나 <b>이미지</b> 파일로 저장할 수 있습니다. A4 한 장에 가로 2반씩 깔끔하게 들어갑니다.<br>바로 인쇄도 가능합니다.<br>맨 위 제목은 <b>학년 + 시간표 이름</b>으로 자동으로 채워지니, 저장소에서 이름을 알아보기 쉽게 지어두면 그대로 문서 제목이 됩니다.'
            },
            {
