        ...
        return [
            {
                ...
                sel: '.lib-grid',
                title: '① 시간표 저장소',
                text: '지금까지 만든 시간표가 카드로 쌓여 있어요.<br>카드를 누르면 이어서 편집해요.<br>여기서 지은 <b>이름</b>이 나중에 인쇄·저장할 때 <b>제목</b>이 됩니다.'
            },
            {
                sel: '.lib-sample',
                title: '첫 카드는 예시',
                text: '맨 앞 카드는 연습용 <b>예시</b>예요.<br>눌러서 마음껏 살펴보세요. <b>저장되지 않아요.</b>'
            },
            {
                sel: '.lib-card .lib-actions',
                title: '이름 변경 · 삭제',
                text: '카드마다 <b>이름 변경</b>, <b>삭제</b> 버튼이 있어요.<br>삭제하면 되돌릴 수 없어요.'
            },
            {
                sel: '#library-overlay .ts-old-view-btn',
                title: '학년별로 따로 저장돼요',
                text: '학년마다 시간표가 완전히 따로 저장돼요.<br>이 버튼으로 다른 학년으로 바꿀 수 있어요.'
            },
            {
                sel: '.lib-new',
                title: '새 시간표 만들기',
                text: '새 주를 시작할 때 누르세요.<br>이름은 나중에 인쇄 제목이 되니 <b>“5주차(9.14-9.18)”</b>처럼 알아보기 쉽게 지어주세요.'
            },
            {
                before: () => { hideAll('tile-step-overlay'); this.openTileStep(); },
                sel: '#tile-step-body .ts-class-card',
                title: '② 1단계 — 전담 시간표 확인',
                text: '전담 수업이 미리 채워져 있어요.<br>과목을 누르고 다른 칸을 누르면 <b>자리가 바뀌어요</b>. ✕는 지우기예요.'
            },
            {
                sel: '#tile-step-bar',
                title: '이번 주 전담 켜고 끄기',
                text: '이번 주에 쓸 전담만 켜두세요.<br><b>끄면</b> 빠지고, <b>켜면</b> 다시 들어와요.'
            },
            {
                sel: '#tile-step-overlay .ts-header-sub',
                title: '이번 주만 고정하고 싶다면',
                text: '빈 칸을 누르고 과목명을 쓰면 그 칸만 고정돼요.<br>주황색 점선으로 표시돼요.'
            },
            {
                sel: '#btn-ts-settings',
                title: '설정은 여기에',
                text: '학급 수, 과목, 전담 시간표를 여기서 정해요.<br>여기서 만든 전담은 1단계에 자동으로 반영돼요.'
            },
            {
                before: () => { hideAll('step2-overlay'); this.openStep2(); },
                sel: '#step2-body .s2-grid',
                title: '③ 2단계 — 과목별 이번 주 시수',
                text: '과목마다 이번 주 시수를 입력하세요. <b>모두 0부터 시작</b>해요.<br>1단계에서 이미 채운 만큼은 3단계에서 자동으로 빼고 배정돼요.'
            },
            {
                sel: '#step2-body .s2-toggle',
                title: '연차시 설정',
                text: '켜두면 그 과목이 <b>2시간 연달아</b> 배정돼요.<br>미술처럼 이어서 하는 과목에 켜세요.'
            },
            {
                before: () => { hideAll('step3-overlay'); this.openStep3(); },
                sel: '#step3-body .s3-card',
                title: '④ 3단계 — 반별 시간표 배정',
                text: '과목을 누르고 다른 칸을 누르면 <b>자리가 바뀌어요</b>.<br>다른 반과 전담이 <b>같은 시간에 겹치면</b> 칸이 빨갛게 표시돼요.'
            },
            {
                sel: '#step3-body .s3-status',
                title: '반마다 실시간 확인',
                text: '배정된 수와 목표를 바로 보여줘요.<br>초록이면 맞는 것, <b style="color:#dc2626">빨간색</b>이면 다시 확인이 필요해요.'
            },
            {
                sel: '#step3-overlay .ts-next-btn',
                title: '과목 배정',
                text: '누르면 빈 칸에 나머지 과목이 자동으로 채워져요.<br>마음에 안 들면 다시 눌러 새로 배정할 수 있어요.'
            },
            {
                sels: ['#btn-s3-pdf', '#btn-s3-image', '#btn-s3-print'],
                title: '저장 · 인쇄',
                text: '<b>PDF</b>·<b>이미지</b>로 저장하거나 바로 <b>인쇄</b>할 수 있어요.<br>제목은 저장소에서 지은 시간표 이름 그대로 나와요.'
            },
            {
                before: () => { hideAll('library-overlay'); this.openLibrary(); },
                sel: null,
                title: '준비 끝!',
                text: '<b>저장소 → 1단계 → 2단계 → 3단계</b> 순서로 진행하면 돼요.<br><b>자동 저장</b>되니 따로 저장하지 않아도 돼요.<br>다시 보려면 🎓 버튼을 누르세요.'
            }
        ];
    },
